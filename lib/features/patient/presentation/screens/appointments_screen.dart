...
class _AppointmentCard extends StatelessWidget {
  ...
  /// Opens/copies the Google Meet link generated by the backend for this
  /// online appointment (available once the final payment completes it).
  ...
  Widget build(BuildContext context) {
    ...
    if (appointment.isOnline && appointment.resolvedMeetLink != null) {
      actions.add(
        _ActionButton(
